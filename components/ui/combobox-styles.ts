...
export const comboTriggerClass =
  'flex min-h-12 w-full items-center justify-between gap-3 rounded-xl border border-input bg-card px-3.5 py-2.5 text-left text-base shadow-sm outline-none transition-colors hover:border-primary/30 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm'
...
export function comboItemClass(active?: boolean) {
  return cn(
    'w-full rounded-lg px-3 py-2.5 text-left text-base transition-colors md:text-sm',
